---
name: simplify
description: Conduct a parallel review of the modified code from three perspectives (code reuse, quality, and efficiency), and automatically fix valid issues. Launch the agents with requests such as “Review the code,” “Review the changes,” and “Check the diff.”
---
...
When crafting prompts for each agent, include the review criteria
from `references/review-criteria.md` (if available) to guide
